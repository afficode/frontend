...
import { Approutes, SEO_PAGES } from '../../constants';
			...
			<section className=' w-full px-[1.5rem] lg:px-[4rem] max-w-[1380px] mx-auto'>
				<div className=' text-white flex flex-col gap-[1.5rem] md:gap-[3rem] py-8'>
					<div className='grid grid-cols-1 items-center'>
						<div className='col-span-2  space-y-2'>
							...
							<p className='text-justify p-lg'>
								Shop and sell securely with Boonfu's escrow protection (Grab) - your funds are safe until delivery is confirmed. Our verified marketplace ensures trustworthy transactions, while
								real-time tracking keeps you in control. Sellers can boost sales through our Grab Feature, where independent marketers promote your products for commission-on-sale. Enjoy instant dispute
								resolution and worry-free commerce. At Boonfu, security and growth go hand-in-hand! <br />
								#SecureTransactions #EarnWithBoonfu
							</p>
							<div className='space-y-1'>
								<h4 className='text-start'>Product Page Disclaimer</h4>
								<div className='text-justify p-lg'>
									Boonfu is a C2C marketplace—we do not sell, inspect, or guarantee any listed item. All listings are posted by private individuals.
									<ul>
										<li>● For GRAB listings: Payment is protected by Boonfu Escrow (funds held until you confirm pickup). Inspect before confirming—sales are final after confirmation.</li>
										<li>● For NON-GRAB listings: No Escrow protection—transactions are direct between you and the seller. Boonfu offers no support or refunds for these deals.</li>
									</ul>{' '}
									<br />
					...
					<div className='grid max-[450px]:grid-cols-1 grid-cols-2 lg:grid-cols-4 gap-6 justify-between'>
						...
						<ul className='flex flex-col '>
							<h6 className='px-2 md:px-8 text-2xl opacity-[.7] font-normal whitespace-nowrap mb-3'>Resources</h6>
						...
						<ul className='flex flex-col '>
							<h6 className='px-2 md:px-8 text-2xl opacity-[.7] font-normal whitespace-nowrap mb-3'>Social</h6>
							<div className='flex gap-4 px-2 md:px-8'>
								<Link to={'https://web.facebook.com/profile.php?id=61550635179141'} rel='noopener noreferrer' target='_blank' className='hover:text-secondary'>
									<FaFacebook size={28} />
								</Link>
								<Link to={'https://twitter.com/affi_ng88124'} rel='noopener noreferrer' target='_blank' className='hover:text-secondary'>
									<FaTwitter size={28} />
								</Link>
								<Link to={'https://www.instagram.com/contactaffi/'} rel='noopener noreferrer' target='_blank' className='hover:text-secondary'>
									<FaInstagram size={28} />
								</Link>
							</div>
						</ul>
