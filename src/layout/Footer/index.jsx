...
const Footer = () => {
	return (
		<footer className="bg-blue w-full px-[1.5rem] lg:px-[4rem] mt-auto ">
			<div className="text-white flex flex-col gap-[1.5rem] md:gap-[3rem] py-8">
				<div className="grid grid-cols-1 items-center gap-[1rem] md:gap-0 md:grid-cols-3 md:divide-x-4 divide-white">
					<div className="col-span-2 md:mr-[2rem] lg:mr-[8rem] space-y-2">
						<h3 className="text-center md:text-start">Transact with peace of mind on Affi.ng</h3>
					...
					<div className="flex flex-col items-center justify-center text-center gap-3">
						...
						<div className="flex gap-4">
							<Link to={'https://web.facebook.com/profile.php?id=61550635179141'} rel="noopener noreferrer" target='_blank' className="hover:text-yellow">
								<FaFacebook size={28} />
							</Link>
							<Link to={'https://twitter.com/affi_ng88124'} rel="noopener noreferrer" target='_blank' className="hover:text-yellow">
								<FaTwitter size={28} />
							</Link>
							<Link to={'https://www.instagram.com/contactaffi/'} rel="noopener noreferrer" target='_blank' className="hover:text-yellow">
								<FaInstagram size={28} />
							</Link>
						</div>
					</div>
				...
				{/* footer lists  */}
				<ul className="w-full flex items-center max-md:justify-center divide-x-8 divide-white flex-wrap">
				...
				<p className="text-center md:text-start">
					&copy; Copyright 2023 <b><Link to={'/'}>Affi.ng</Link></b>. All rights reserved.
				</p>
			</div>
		</footer>
	);
