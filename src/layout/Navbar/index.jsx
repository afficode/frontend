            ...
            <div className="max-w-[1380px] mx-auto px-2 relative flex items-center justify-between w-full  whitespace-nowrap  ">
              {pathname === "/" ? (
                ...
                <div className="dropdown">
                  <div
                    tabIndex={0}
                    className="mr-16 text-white cursor-pointer max-md:hidden"
                  >
                    <VscMenu size={30} />
                  </div>
                  <ul
              ...
              <ul className="flex items-center justify-between w-full">
                ...
                <li className="dropdown dropdown-hover">
                  ...
                  <Dropdown
                    ...
                    subCategories={automobileCategoriesData}
                  />
                </li>
                ...
                <li className="dropdown dropdown-hover">
                  ...
                  <Dropdown
                    category={"PROPERTY"}
                    subCategories={propertyCategoriesData}
                  />
                </li>
                ...
                <li className="dropdown dropdown-hover ">
                  ...
                  <Dropdown
                    category={"SERVICES"}
                    subCategories={servicesCategoriesData}
                  />
                </li>
                ...
                <li className="dropdown dropdown-end dropdown-hover mr-4">
                  ...
                  <Dropdown
                    category={"DEALS"}
                    subCategories={forSaleCategoriesData}
                  />
                </li>
              </ul>
            </div>
