            ...
            <div className="max-w-[1380px] mx-auto px-2 relative flex items-center justify-between w-full  whitespace-nowrap  ">
              {pathname === "/" ? (
                ...
                <div className="dropdown">
                  <div
                    tabIndex={0}
                    className="mr-16 text-white cursor-pointer max-lg:hidden"
                  >
                    <VscMenu size={30} />
                  </div>
                  <ul
              ...
              <ul className="flex items-center justify-between w-full">
                ...
                <li className="dropdown dropdown-hover">
                  <NavLink
                    to={generateCategoryUrl("Vehicles")}
                    tabIndex={0}
                ...
                <li className="dropdown dropdown-hover">
                  <NavLink
                    to={generateCategoryUrl("Property")}
                    tabIndex={0}
                    className={listStyles}
                  >
                    PROPERTY
                ...
                <li className="dropdown dropdown-hover ">
                  <NavLink
                    to={generateCategoryUrl("Services")}
                    tabIndex={0}
                    className={listStyles}
                  >
                    SERVICES
                ...
                <li className="dropdown dropdown-end dropdown-hover">
                  ...
                  {dealsCat && (
                    <Dropdown category={"DEALS"} subCategories={dealsCat} />
                  )}
                </li>
                ...
                <li className="dropdown dropdown-end dropdown-hover mr-4">
                  ...
                  {dealsCat && (
                    <Dropdown category={"REQUESTS"} subCategories={dealsCat} />
                  )}
                </li>
              </ul>
            </div>
