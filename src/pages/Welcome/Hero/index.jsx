...
// icons
import { responsive2 } from '../../../constants';
import { Boonfu1, Boonfu2, Boonfu3 } from '../../../assets/images';
		...
		<section className="w-full">
			...
			>
				<div className="w-full">
					<img src={Boonfu1} alt="banner 1" />
				</div>
				<div className="w-full">
					<img className="w-full h-auto object-cover" src={Boonfu2} alt="banner 2" />
				</div>
				<div className="w-full">
					<img className="w-full h-auto object-cover" src={Boonfu3} alt="banner 3" />
				</div>
			</Carousel>
		</section>
	);
