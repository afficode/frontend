...
const FeedbackForm = ({ ad_id, buttonText, url, feedback }) => {
    ...
    const validationSchema = Yup.object({
        ...
        positive: feedback
            ? Yup.bool().required('What kind of feedback is this')
            : Yup.bool(),
    });
                                    ...
                                    <div className="flex items-center justify-around w-full mb-2">
                                        <span>
                                            <label
                                                ...
                                                htmlFor="true"
                                                className={`tooltip tooltip-success text-green-500 ${
                                                    feedbackType ? 'bg-green-300 rounded-full p-2' : ''
                                                }`}
                                        ...
                                        <span>
                                            <label
                                                ...
                                                htmlFor="false"
                                                className={`tooltip tooltip-error text-red-700 ${
                                                    feedbackType === false
                                                        ? 'bg-red-300 rounded-full p-2'
                                                        : ''
                                                }`}
