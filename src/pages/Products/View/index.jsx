                    ...
                    <div className='w-full my-2 '>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            {result?.data?.paid === 0 &&
                                ...
                                <span
                                    className={
                                        'px-4 py-1 rounded-lg text-white bg-green-700  '
                                    }
                                >
                                    Active
                                </span>
                                ...
                                <span
                                    className={
                                        'px-4 py-1 rounded-lg text-white bg-gray-700  '
                                    }
                                >
                                    Closed
                                </span>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            if (
                                                ...
                                                notify(
                                                    'Please login to reveal phone number'
                                                );
                                            }
                                        }}
                                    >
