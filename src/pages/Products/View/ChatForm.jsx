		...
		mutate(message, {
			...
			onSuccess: ({ data }) => {
				...
				if (data.success) {
					...
					toast.success('Message sent successfully, The ad owner will be in touch with you soon.');
				}
			},
		});
	};
...
car, is it still available?`
					...
					<p className="w-full text-center my-2 ">
						...
						conversations sent through our servers to protect you from fraud,spam or suspicious behavior.
					</p>
					{chatId ? (
