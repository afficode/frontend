...
const SideBar = ({ displayCategories, currentCategoryId }) => {
	...
	const handleCategoryChange = (newCategoryId) => {
		...
		navigate(`${Approutes.product.viewCategoryId.replace(':id', getCategoryName(newCategoryId))}`, { replace: true, search: `?${new URLSearchParams(newParams).toString()}` });
	};

	return (
		<div>
			<div>
				<header className='bg-primary p-2 text-xl font-semibold text-white tracking-tighter line-clamp-1'>Categories</header>
