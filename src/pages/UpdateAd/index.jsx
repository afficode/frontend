...
const PostAd = () => {
    ...
    const initialValues = {
        50: {
            ...
            contact_type:
                typeof ad?.contact_type === 'string'
                    ? ad?.contact_type?.split(',')
                    : ad?.contact_type,
        ...
        51: {
            ...
            title: ad?.title,
            property_type:
                typeof ad?.property_type === 'string'
                    ? ad?.property_type?.split(',')
                    : ad?.property_type,
            ad_condition: ad?.ad_condition,
            furnished: ad?.furnished,
            time_period: ad?.time_period,
            room_bathroom: ad?.room_bathroom,
            room_bathroom_other: ad?.room_bathroom_other,
            size: ad?.size,
            date_available: ad?.date_available && new Date(ad?.date_available),
            facilities:
                typeof ad?.facilities === 'string' ? ad?.facilities?.split(',') : ad?.facilities,
            images: [],
            description: ad?.description,
            price: toMoney(ad?.price, false),
            negotiable: ad?.negotiable,
        ...
        52: {
            ...
            expertise_other: ad?.expertise_other,
            make: ad?.make,
            make_other: ad?.make_other,
            available_for_travel: ad?.available_for_travel,
        ...
        54: {
            ...
            processor_other: ad?.processor_other,
        ...
        55: {
            ...
            material_other: ad?.material_other,
            display: ad?.display,
            price: toMoney(ad?.price, false),
            negotiable: ad?.negotiable,
            contact_type:
        ...
        56: {
            ...
            price: toMoney(ad?.price, false),
            scent_type_other: ad?.scent_type_other,
            negotiable: ad?.negotiable,
            contact_type:
                typeof ad?.contact_type === 'string'
                    ? ad?.contact_type?.split(',')
        ...
        57: {
            ...
            furniture_for_other: ad?.furniture_for_other,
            formulation: ad?.formulation,
            formulation_other: ad?.formulation_other,
            color: ad?.color,
            price: toMoney(ad?.price, false),
            color_other: ad?.color_other,
            negotiable: ad?.negotiable,
            contact_type:
                typeof ad?.contact_type === 'string'
                    ? ad?.contact_type?.split(',')
