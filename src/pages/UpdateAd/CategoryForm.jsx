	...
	const categoryFields = {
		vehicles: [
			...
			!['5002', '5005'].includes(selectedVehicleCategory) && {
				...
				options: [
					{ key: 'Reverse Camera', value: 'ReverseCamera' },
					{ key: 'Air Conditioning', value: 'AirConditioning' },
					{ key: 'Parking Sensor', value: 'ParkingSensor' },
					{ key: 'Android Audio', value: 'AndroidAudio' },
					{ key: 'Apple Car Play', value: 'AppleCarPlay' },
					{ key: 'Bluetooth Connectivity', value: 'BluetoothConnectivity' },
					{ key: 'Tinted Glass', value: 'TintedGlass' },
					{ key: 'Sat Navigation', value: 'SatNavigation' },
					{ key: 'Alloy Wheels', value: 'AlloyWheels' },
					{ key: 'Sunroof', value: 'Sunroof' },
					{ key: 'Power steering', value: 'Powersteering' },
					{ key: 'Keyless Entry', value: 'KeylessEntry' },
					{ key: 'Central Lock', value: 'CentralLock' },
					{ key: 'Audio System', value: 'AudioSystem' },
				],
			},
			{
				control: 'textarea',
			...
			},
			{
				...
				options: [
					...
					{ key: 'Foreign Used', value: 'foreign_used' },
			...
			!['5002', '5005'].includes(selectedVehicleCategory) && {
				...
				options: [
					...
					{ key: 'Pick-up Truck', value: 'pick-up_truck' },
					{ key: 'SUStation WagonV', value: 'station_wagon' },
					{ key: 'Coupe', value: 'coupe' },
					{ key: 'Sports car', value: 'sports_car' },
					{ key: 'Sedan', value: 'sedan' },
					{ key: 'Minivan', value: 'minivan' },
					{ key: 'Convertible', value: 'convertible' },
					{ key: 'Van', value: 'van' },
					{ key: 'Panel van', value: 'panel_van' },
					{ key: 'Compact car', value: 'compact_car' },
