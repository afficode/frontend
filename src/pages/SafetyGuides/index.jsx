	...
	return (
		<section>
			...
			<div className={`${sectionStyles} flex flex-col gap-2`}>
				...
				<p>At Boonfu, your safety is our top priority. Whether you're buying or selling, following these best practices will help ensure smooth, scam-free transactions.</p>
			</div>
			...
			<div className={`${sectionStyles} flex flex-col gap-2`}>
				...
				<ol className='list-decimal list-inside space-y-2'>
					...
					<li className='font-semibold text-2xl'>
						...
						<div className='pl-6'>
							<ul className='list-disc list-inside font-normal'>
								<li>Confirm the product matches the description and what you ordered online as after item successful delivery, transaction is termed “Closed”</li>
			...
			<div className={`${sectionStyles} flex flex-col gap-2 border-t border-black`}>
				...
				<ol className='list-decimal list-inside space-y-2'>
					...
					<li className='font-semibold text-2xl'>
						...
						<div className='pl-6'>
							<ul className='list-disc list-inside font-normal'>
								<li>Buyers asking to pay via WhatsApp, PayPal Friends & Family, or bank transfer may be scammers.</li>
