const ProductStats = ({ adsData }) => {
	const totalChats = adsData?.ads_summary.map((ad) => ad.chats).reduce((a, b) => a + b, 0);
			...
			<div className="flex bg-gray-200">
				<div className="flex flex-col items-center flex-1 gap-4 px-4 py-6">
					...
					<span className="px-10 py-2 text-center bg-white rounded-lg max-sm:px-4">
						<p className="font-semibold text-primary">[ {adsData?.active_ads} ]</p>
					</span>
				</div>
				<div className="flex flex-col items-center flex-1 gap-4 px-4 py-6">
					<p className="font-bold">Blocked</p>
					<span className="px-10 py-2 text-center bg-white rounded-lg max-sm:px-4">
						<p className="font-semibold text-primary">[ {adsData?.blocked_ads} ]</p>
					</span>
				</div>
				<div className="flex flex-col items-center flex-1 gap-4 px-4 py-6">
					<p className="font-bold text-[#B50444]">Sold</p>
					<span className="px-10 py-2 text-center bg-white rounded-lg max-sm:px-4">
						<p className="font-semibold text-primary">[ {adsData?.sold_ads} ]</p>
					</span>
				</div>
			</div>
		</div>
