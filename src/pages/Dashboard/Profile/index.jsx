...
const Profile = () => {
    ...
    const { mutate, isLoading: isUpdating } = userUpdate(
    ...
    const initialValues = {
        phone:
            user.phone.filter((num) => num.isDefault === '1')[0].number ||
            1000000000,
        ...
        <div>
            ...
            <div className='flex flex-col my-8 md:px-2 lg:px-4'>
                <div className='flex justify-between border-b border-black/30'>
                    ...
                    <div
                        onClick={() =>
                            setToggleEdit((prev) => ({ ...prev, about: false }))
                        }
            ...
            <div className='flex flex-col my-8 md:px-2 lg:px-4'>
                <div className='flex justify-between border-b border-black/30'>
                    ...
                    <div
                        onClick={() =>
                            setToggleEdit((prev) => ({ ...prev, bio: false }))
                        }
                        className='flex gap-1 items-center text-primary text-lg font-medium cursor-pointer'
                    >
                        <img src={EditPencil} alt='/' className='w-4' />
