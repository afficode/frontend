...
const Delivery = () => {
    ...
    const statesOptions = toSelectOptions(
        states,
        'states',
        'Select your state'
    );
        ...
        <section className='mx-6 my-4'>
                ...
                <div className='max-w-[720px] mx-auto space-y-6'>
                    ...
                    <div className='bg-secondary p-4'>
                        <div className='mb-6 space-y-1'>
                            <p className='italic'>
                                Thanks for choosing Boonfu delivery service.
                            </p>
                            <p className='italic'>
                                Please fill the quote form below to enable us
                                generate accurate delivery quote for you.
                            </p>
                        </div>
                        <form
                            autoComplete='off'
            ...
            {stage === 2 && (
                <div className='max-w-[720px] mx-auto py-6'>
                    ...
                    <div className='bg-primary p-4 text-white w-[300px] mx-auto'>
                        ...
                        <p className='border-y border-white py-1 text-lg my-4 font-semibold'>
                            Cost : #3,500
                        </p>
            ...
            >
                <div className='flex flex-col items-center justify-center space-y-4 p-4'>
                    <SpinnerSkeleton />
                    <p>
                        Please wait while your delivery quote is being generated
                    </p>
                    <p className='text-sm max-w-[300px] text-center'>
                        This may take between{' '}
