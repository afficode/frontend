			...
			<div className="px-4 py-6 bg-white">
				...
				{paymentOption === 'transfer' && (
					<div className="my-[2.5rem] space-y-3 ">
						<div className="flex gap-6 items-center max-w-sm my-6">
							<Button
								onClick={() => setTransactionType('deposit')}
								type="button"
								variant={transactionType === 'deposit' ? 'primary' : 'grey'}
								size={'small'}
								className={'w-full'}
							>
								Deposit
							...
							<Button
								...
								type="button"
								variant={transactionType === 'deposit' ? 'grey' : 'primary'}
								size={'small'}
								className={'w-full'}
							>
								Withdraw
								...
								<form onSubmit={formikDeposit.handleSubmit} className="space-y-6 w-full mb-6">
									<div className="flex flex-col">
										...
										<div className="relative max-w-sm">
											...
											/>
											<span className="absolute left-2 inset-y-0 my-auto h-fit font-bold">NGN</span>
											<button
												onClick={() => {
							...
							<form onSubmit={formikWithdraw.handleSubmit} className="space-y-3 max-w-[24rem]">
								<div className="flex flex-col">
									...
									<InputGroup
										...
										optionLists={bankAccountList}
										value={formikWithdraw.values.bank}
										onChange={formikWithdraw.handleChange}
										onBlur={handleWithdrawBlur}
										errorMsg={
											formikWithdraw.touched.bank && formikWithdraw.errors.bank
												? formikWithdraw.errors.bank
												: null
										}
									/>
								</div>
								...
								<div className="flex flex-col">
									...
									<div className="relative max-w-sm">
										<InputGroup
											...
											onBlur={handleWithdrawBlur}
											errorMsg={
												formikWithdraw.touched.amount && formikDeposit.errors.amount
													? formikDeposit.errors.amount
													: null
											}
										/>
...
const bankAccountList = [
	{ value: '0', key: 'Select Account' },
	{ value: '23', key: 'Keystone Bank - 1234567890' },
	{ value: 'new', key: 'Withdraw to a new bank account' },
];
