		...
		<div className="space-y-4 py-8 px-8 max-sm:px-4 bg-secondary">
			...
			{has_pending_refund ? (
				<div className='bg-white p-4 text-justify space-y-2 rounded-md'>
					<p>We sincerely apologize for any inconvenience you may have experienced that led to this request. At Boonfu, we strive to provide a seamless experience, and we regret that we fell short this time.</p>
					<p className='my-4'>What happens next? One of our Customer Service personnel is currently reviewing your request to ensure all details are correct. As soon as the review is finalized, your refund will be credited directly to your Boonfu Wallet. From there, the funds will be immediately available for withdrawal to your bank account or for future use on the platform.</p>

					<p className="my-2">We appreciate your patience while we finalize this process.</p>
