				...
				<div className='flex items-center justify-center w-full h-[70vh]'>
					<div className='flex flex-col gap-4 w-full h-max max-w-[600px] text-center p-4 bg-white'>
						<div className='bg-secondary p-4 space-y-2'>
							...
							<p>
								This ad is currently locked due to an active
								transaction. To protect both buyers and sellers,
								listings become temporarily unavailable once a
						...
						<div className='space-y-4 text-start'>
							...
							<ul>
								...
								<li>
									✅ Check back in 24-48 hours if the deal
									falls through
								</li>
								<li>
									✅ Contact support@boonfu.com for urgent
									inquiries
								</li>
							</ul>

							<p>
								Thank you for understanding our secure
								transaction process!
							</p>
						</div>
					</div>
				...
				<div>
					...
					<div className='flex flex-col space-y-6 lg:space-y-4 w-full md:w-[80%] mx-auto'>
						...
						<section className='border border-black'>
							<h5 className='py-2 px-4 font-bold bg-gray-300'>
								Review Item
							</h5>

							<div className='px-4 pt-2 pb-6'>
								<h6 className='text-black/60 py-2'>
								...
								<div className='flex gap-6'>
									...
									<div className='flex flex-col gap-4'>
										...
										<div className='border border-black/40 p-2 md:p-4 bg-secondary text-justify '>
											At Boonfu Marketplace, we are
											committed to ensuring a secure
											and efficient transaction
											experience for both buyers and
											sellers. The following policy
