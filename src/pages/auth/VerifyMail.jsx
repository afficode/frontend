        ...
        if (token) {
            try {
                const response = await axios.get(
                    `${backendLink}auth/verify_account`,
                    {
                        headers: {
            ...
            <div className='w-full  flex items-center justify-center  '>
                <div className='md:w-[50%] w-[90%] my-[5rem] '>
                    ...
                    {/* <p className=' text-black text-[1.2rem] font-normal mt-6 text-center'>
                        To start using Boonfu, confirm your email address{' '}
                        <b>and</b> phone number with OTP sent respectively, to:
                    </p>
