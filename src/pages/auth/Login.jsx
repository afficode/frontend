		...
		<div className='w-full '>
			{isLoading ? (
				<div className='mt-4 lg:mt-20'>
					<SpinnerSkeleton heading={'You’re being logged on.'} body={'...learn more about the Grab system too 😊.'} type={'spin'} color={'#2686CE'} height={250} width={250} />
				</div>
			) : (
				<>
						...
						<Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
							{(formik) => (
								<Form>
									...
									<div className='form-control'>
										<Input className={inputClass} type='password' name='password' id={`${id}-login-password`} placeholder='Password' {...formik.getFieldProps('password')} />
									</div>
									...
									<div className=' form-control'>
										...
										>
											{formik.isSubmitting ? (
												<>
													<Spinner color={'secondary'} /> &emsp; <span className='my-auto text-xl'>Submitting Data...</span>{' '}
												</>
											) : (
