...
const Hero = () => {
  return (
    <section className="px-4 lg:pt-16 pb-12 hero bg-gradient-to-b from-primary/20 via-blue/60 to-white">
  ...
  return (
    <div className="w-full sm:max-w-[18rem] h-[23rem] flex flex-col items-center hero-card text-center justify-between rounded-md px-4 py-6 bg-white shadow-md cursor-pointer hover:scale-105 hover:shadow-lg transition-all ">
      ...
      <img
        src={image}
        alt="for sale image"
        className="w-[11rem] h-[9rem] object-contain"
      />
      <p className="p-lg ">{description}</p>
      <button className="mt-4 text-lg capitalize border-none btn rounded-3xl hover:border-black/50 hover:border-solid hover:bg-yellow/90 bg-secondary px-8 text-white">
        {action}
      </button>
    </div>
  );
...
const cardData = [
  {
    ...
    image: Sale,
    description:
      "Buy, Sell and Make Money on Affi. \nGenuine products await you.",
    action: "Transact Now",
  },
  {
    title: "Services",
    image: Services,
    description:
      "Hire verified professionals  for all your service needs Today!",
    action: "Search Now",
  },
  {
    title: "Property",
    image: Property,
    description:
      "Buy, Rent and Lease property. Also, find verified agents near you, across Nigeria",
    action: "Start Now",
  },
  {
    title: "Cars & Vehicles",
    image: Vehicles,
    description:
      "Find thousands of vehicles and automobiles as Buyer, Seller and a Dealer.",
    action: "Explore Now",
  },
];
