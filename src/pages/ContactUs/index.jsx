...
const ContactUs = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setLoading(false);
			notify('An error occurred try again', 'error');
		}
	};
	...
	return (
		<section>
			<div className='bg-primary py-12 px-4 sm:px-[4rem] m-2 rounded-md text-center text-white'>
				...
				<p className='mt-3 text-gray-300 dark:text-gray-400'>We'd love to hear from you. Please fill out this form or send us an email.</p>
			</div>
				...
				<div className='p-4 '>
					<form onSubmit={handleSubmit}>
						...
						<div className='max-sm:text-center'>
							...
							<Button variant={'primary'} size={'small'} loading={loading} disabled={loading} className={'flex items-center gap-2 p-2 rounded-md'}>
								Send message <BiEnvelope size={20} />
							</Button>
						</div>
					</form>
			...
			<ScrollToTop />
			<SEO title={`Contact Us`} description='Get in touch with our team for any inquiries or support.' image={BoonfuLogo} url='https://www.boonfu.com/contact-us' />
		</section>
	);
};
