		...
		<div className="space-y-6 px-4 py-2 sm:py-4 sm:text-justify">
			...
			<div className="space-y-4 sm:px-[4rem]">
				<p className={textStyles}>
					This Cookie Policy explains how we use cookies and similar technologies when you access or use
					our services. It also outlines the options available to you to manage or control these
					technologies. By continuing to browse or use our platform, you consent to our use of cookies as
					described here.
				</p>

				<p className={textStyles}>
					Boonfu Limited is responsible for the use and management of cookies on this Service. For
				...
				<p className={textStyles}>
					Cookies are small text files placed on your device (such as a computer or smartphone) when you
					visit our Service. These files store certain information — for example, your language
					preference, browser type, or device details.
				</p>
				...
				<ul className={listStyles}>
					<li>
						<b>First-party cookies</b> – set directly by Boonfu to support the functionality and
						performance of our Service.
					</li>
					<li>
						<b>Third-party cookies</b> – set by external domains for analytics, advertising, and marketing
						purposes.
					</li>
				</ul>
				...
				<ul className={listStyles}>
					<li>
						<b>Session Cookies</b> – These expire once you close your browser. They help link your actions
						during a single session.
					</li>
					<li>
						<b>Persistent Cookies</b> – These remain on your device until they expire or are manually
						deleted. They help remember your preferences and activities across sessions.
					</li>
				</ul>
				...
				<p className={textStyles}>
					You can control cookies through your browser or device settings, though restricting cookies may
					affect your browsing experience.
				</p>

				<p className={`${textStyles} font-semibold mt-4`}>Browser and Device Settings</p>
				<p className={textStyles}>
					Most browsers allow you to block or delete cookies. The method depends on the browser. You can
					find instructions at the links below:
				</p>
				<ul className={listStyles}>
					<li>
				...
				<p className={`${textStyles} font-semibold text-red-500 mt-4`}>
					Please note: Blocking all cookies may impact functionality and some features may not work
					properly.
				</p>
				...
				<p className={textStyles}>
					To reset device identifiers or opt out of personalized ads, follow Google or Apple
					instructions.
				</p>

				<p className={`${textStyles} font-semibold mt-4`}>Opt-Out of Internet-Based Advertising</p>
				<p className={textStyles}>
					Some third-party advertisers and networks we work with participate in industry-wide opt-out
					programs. You may opt out at:
				</p>
				<ul className={listStyles}>
					<li>
				...
				<ul className={listStyles}>
					...
					<li>
						To analyze visitor activity, identify popular and less visited pages, and improve navigation.
					</li>
				...
				<p className={textStyles}>
					The following table outlines the different categories of cookies we use and their purposes:
				</p>
						...
						<tbody>
							<tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
								...
								<td className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-gray-500 dark:text-gray-400">
									Necessary for the website to function. They allow you to log in and use the secure Escrow
									and Wallet features.
								</td>
							</tr>
							<tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
								...
								<td className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-gray-500 dark:text-gray-400">
									Used to remember your choices and provide enhanced, personal features.
								</td>
							</tr>
							<tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
								<td className="border border-gray-300 dark:border-gray-600 px-4 py-3">
								...
								<td className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-gray-500 dark:text-gray-400">
									Help us understand how visitors interact with the site by collecting and reporting
							...
							<tr className="hover:bg-gray-50 dark:hover:bg-gray-800">
								...
								<td className="border border-gray-300 dark:border-gray-600 px-4 py-3 text-gray-500 dark:text-gray-400">
									Used to deliver adverts relevant to you and your interests, especially within our Affiliate
									"Grab" network.
								</td>
							</tr>
						</tbody>
				...
				<p className={textStyles}>
					We may update this Cookie Policy from time to time. When changes occur, we will update the
					"Last Updated" date on this page. Your continued use of the Service following any changes
