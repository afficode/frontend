    ...
    <div className="bg-gray-200 rounded-sm">
      <div className="flex ">
        ...
        <div className="flex-1 flex flex-col justify-between px-1 py-2 sm:p-4">
          <div className="flex flex-col">
            <div className="flex">
              <h4 className="text-primary font-semibold max-lg:hidden">
                {name}
              </h4>
              <h5 className="text-primary font-semibold lg:hidden max-sm:hidden">
                {name}
              </h5>
      ...
      <div className="w-full flex items-center md:hidden divide-x-2 divide-gray-200">
        <Button
          variant={"plain"}
          size={"small"}
          className={`font-semibold max-sm:text-sm flex-1`}
        >
          Show contact{" "}
        </Button>
        <Button
