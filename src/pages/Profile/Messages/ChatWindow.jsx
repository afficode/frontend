        ...
        <>
            {Object.keys(data).length <= 0 ? (
                ...
                <div className="bg-primary w-full sm:w-full h-[calc(100vh-15rem)]  rounded-xl pt-1 pb-4 px-1 flex flex-col  ">
                    {/* chat window header  */}
                    <h5 className="text-center p-2 text-base font-semibold text-white">
                    ...
                    <div className="flex gap-2 justify-between items-center flex-wrap w-full px-2 py-1 bg-gray-100 shadow-lg sm:py-2 rounded-xl">
                        <Link
                            to={`/product/${slugGeneratorForAdIdWithName(data?.title, data?.ad_id)}`}
                            className="max-w-max w-full"
                        >
                            <div className="flex gap-2 items-center">
                                <img
                                    src={data?.image[0].path || noimage}
                        ...
                        {showContact ? (
                            ...
                            <Button
                                ...
                                size={'small'}
                                className={
                                    '!py-[0.125rem] px-[1rem] h-max leading-6 rounded-md text-sm whitespace-nowrap'
                                }
                            >
                                View contact
                            </Button>
