...
const CategoryForm = ({ categoryId, categoryName, initialValues }) => {
    ...
    const servicesExpertiseOptions = toSelectOptions(
        tutorialTopics,
        'topic',
        'Select expertise here'
    );
    ...
    const motorbikeTypeOptions = toSelectOptions(
        motorbikeType,
        'motorbikeType',
        'Select type here'
    );
    ...
    const furnitureForOptions = toSelectOptions(
        furnitureFor,
        'furnitureFor',
        'Select furniture for'
    );
    ...
    const storageSizeOptions = toSelectOptions(
        storageSize,
        'storageSize',
        'Select storage size here'
    );
    const storageTypeOptions = toSelectOptions(
        storageType,
        'storageType',
        'Select storage type here'
    );
    ...
    const petTypeOptions = toSelectOptions(
        petTypes[selectedPetCategory] === undefined
            ? petTypes.default
            : petTypes[selectedPetCategory],
        'petType',
        'Select a breed type'
    );
    ...
    const categoryFields = {
        vehicles: [
            ...
            ['5005', '5007'].includes(selectedVehicleCategory) && {
                ...
                options:
                    selectedVehicleCategory === '5007'
                        ? otherVehicleTypeOptions
            ...
            },
            {
                control: 'radio',
                type: 'radio',
                label: ['5002', '5005'].includes(selectedVehicleCategory)
                    ? 'Condition'
                    : 'Vehicle Condition',
                name: 'ad_condition',
                options: [
        ...
        properties: [
            ...
            ['5101', '5102', '5103', '5104', '5107', '5108', '5109'].includes(
        ...
        health: [
            ...
            !['5603', '5601', '5605', '5607', '5608', '5604', '5606'].includes(
        ...
        tradesman: [
            ...
            ['5812'].includes(selectedTradesmanCategory) && {
                ...
                options: [
                    ...
                    {
                        key: 'Intermodal/modal Transportation',
                        value: 'Intermodal/modal Transportation',
                    },
                ],
            },
            ...
            try {
                ...
                const message =
                    error instanceof Error
                        ? error.message
                        : 'File is corrupt or format is unsupported.';
                ...
                return (
                    <Form encType='multipart/form-data'>
                        {renderFields ? (
                            ...
                            <div className='text-center'>No fields to display</div>
                        )}
                        ...
                        <p className='mt-4 text-center'>
                            ...
                            <button
                                className='text-primary'
                                onClick={() => handleScrollTo(privacyRef)}
                            >
                                Privacy Notice
                            </button>{' '}
