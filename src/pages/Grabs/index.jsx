		...
		<section className="min-h-screen px-4 py-4 space-y-4 text-center">
			...
			<div className="rounded-lg bg-primary max-w-[1024px] mx-auto">
				<p className="p-4 text-white">
					“Grab” is an affiliate marketing system where you can generate post(s) of product(s) or item(s)
					of your choice from different sellers and share on your social media platform to market to your
					contacts or followers for a commission when the item/product is sold using your link embedded
					in the fliers shared
				</p>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 place-items-center gap-y-12 max-w-[960px] mx-auto ">
				<div className="relative w-[350px] max-sm:w-[300px] h-fit mt-12 ">
					...
					<div className=" p-6 space-y-4 text-center border border-black rounded-md h-[230px] ">
						<h3>Register</h3>
						<p className="p-lg">
							Register as a Grabber by filling out the quick, easy form. Fill in all your social media
							handles for ease of sharing.
						</p>
					</div>
				</div>
				...
				<div className="relative w-[350px] max-sm:w-[300px] h-fit mt-12 ">
					...
					<div className=" p-4 space-y-4 text-center border border-black rounded-md max-sm:h-[250px] h-[230px] ">
						<h3>Grab & Share</h3>
						<p className="p-lg">
							Browse through Items/products to locate products with Grab icons, Click on the icon to
							generate a social media flier of the product for you, click on “share” publish on your to
							platforms.
						</p>
					</div>
				</div>
				...
				<div className="relative w-[350px] max-sm:w-[300px] h-fit mt-12 ">
					...
					<div className=" p-6 space-y-4 text-center border border-black rounded-md max-sm:h-[250px] h-[230px] ">
						...
						<p className="p-lg">
							If someone interacts with your shared flier, and eventually buys such item/product through
							your link, you earn a commission on such transaction, your wallet is credited
						</p>
					</div>
				</div>
				<div className="relative w-[350px] max-sm:w-[300px] h-fit mt-12 ">
					...
					<div className=" p-6 space-y-4 text-center border border-black rounded-md h-[230px] ">
						...
						<p className="p-lg">
							Watch how your wallet grows with your commission in it, the more items/products shared, the
							higher your chances of people buying through you and higher commission as well.
						</p>
					</div>
				</div>
			</div>
