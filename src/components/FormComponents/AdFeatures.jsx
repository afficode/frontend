...
const AdFeatures = (props) => {
	...
	return (
		<div id='post-package' className={`scroll-mt-[100px] bg-white  ${showGrab && !showCalc ? 'mb-32 transition-all' : showGrab && showCalc ? 'mb-48 transition-all' : ''}`}>
			...
			<div className='relative'>
				<div className='overflow-auto px-3 py-8 '>
											...
											return (
												<tr key={option.value} className='flex'>
													<td className='flex items-center gap-4'>
														<input {...field} {...rest} type='radio' id={option.value} value={option.value} checked={field.value === option.value} />
														<label htmlFor={option.value} className={`${option.color} uppercase flex justify-center w-[10rem] py-1`}>
															{option.key}
														</label>
													</td>
					...
					{/* grab feature */}
					<div className={`${' transform translate-x-[-1.2%] transition-all duration-500 opacity-100'} sm:space-y-6 space-y-6 sm:p-8 p-4 absolute top-0 max-sm:left-1 bg-white z-10 w-full `}>
						{showGrab && (
							<>
																		...
																		{inspectableCategories.includes(parseInt(subCat)) ? (
																			<ol>
																				<div>
																					...
																					<p className='ml-10'>
																						To use the Grab Feature, you need to fund your wallet with 1% of your
																						Item’s price. Example: If your item costs ₦10,000,000, you’ll deposit
																						₦100,000. This 1% serves as the Grab Feature commission.
																					</p>
																				</div>
																				<div>
																					<span className='flex items-center gap-1'>
																					...
																					<div className='ml-10'>
																						...
																						<ul className='ml-6'>
																							<li className='list-disc'>
																								{' '}
																								Our Grabbers don’t sell your item, or{' '}
																							</li>
																							<li className='list-disc'>You sell it outside this platform, </li>
																						</ul>
																						you’ll get 90% of your deposit back, while 10% is charged as
																						administrative fee.
																					</div>
																				</div>
																				<div>
																					...
																					<p className='ml-10'>
																						If a Grabber sells your item, your 1% deposit becomes the sales
																						commission. (No refund applies in this case.)
																					</p>
																				</div>
																				<div>
																					<span className='flex items-center gap-1'>
																					...
																					<p className='ml-10'>
																						...
																						administrative fee, and the balance will be made available as
																						“withdrawable”
																					</p>
																				</div>
																				<div>
																					...
																					<p className='ml-10'>
																						You can’t request a withdrawal while your advert is still active. Please
																						close the advert first, then place your withdrawal request
																					</p>
																				</div>
																			</ol>
																		) : (
																			<ol>
																				<div>
																					...
																					<p className='ml-4'>
																						The required Grab Listing Fee will be automatically deducted from your
																						Boonfu Wallet Balance. You must fund your wallet with the required amount
																						before you can publish an advert using the Grab Feature.
																					</p>
																				</div>
																				<div>
																					<li className='list-decimal ml-4 font-semibold !text-base'>
																					...
																					<p className='ml-4'>
																						Items listed with the Grab Feature receive intensive marketing and
																						promotion both within and outside the Boonfu platform.This premium
																						promotion runs for a period of one (1) month.
																					</p>
																				</div>
																				<div>
																					<li className='list-decimal ml-4 font-semibold !text-base'>
																					...
																					<p className='ml-4'>
																						If your item is not sold within the 1-month Grab period, you have two
																						options:
																					</p>
																					<ol className='ml-4'>
																						<div>
																							...
																							<p className='ml-4'>
																								You can switch the advert from Grab to a standard Basic
																								Listing while maintaining the original price of item for
																								another one month.
																							</p>
																						</div>
																						<div>
																							...
																							<p className='ml-4'>
																								IF you adjust (reduce) the item’s price by at least 10%,
																								it qualifies for an additional one (1) month promotion
																								with Grab feature.
																							</p>
																						</div>
																					</ol>
						...
						<div className={'flex justify-center w-full  px-8'}>
							<Button type='button' variant={'primary'} className='bg-red-600 text-white text-center font-semibold' onClick={() => setShowGrab(!showGrab)}>
