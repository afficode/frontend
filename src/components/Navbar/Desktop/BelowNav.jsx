...
const BelowNav = () => {
  ...
  const liClassSingle =
    "transition ease-in-out delay-100 hover:underline hover:text-yellow-200 duration-300";
  const liClass =
       ...
       <div className="bg-green-400 px-3 py-2 shadow-yellow-200 shadow-inner">
        <div className="flex items-center justify-start gap-3">
          <div className="w-full">
            <ul className="grid grid-cols-5 divide-x-4 text-center cursor-pointer font-semibold ">
              <li 
              onMouseEnter={() => { resetAllDiv(); }}
              className={liClassSingle}>SET UP A SHOP</li>
              <li
                onMouseEnter={() => {
                  toggleVehicle(true);
        ...
        >
          <div className="grid grid-cols-3 divide-x-4 cursor-pointer font-light gap-3">
            ...
            <div id="right" className="pl-3">
              <span className="font-bold text-lg text-black text-center block w-full mb-5">
                <FontAwesomeIcon
                  icon={faBinoculars}
                  className="my-auto text-lg text-gray-600"
                />{" "}
