...
const SEO = ({ title, description, image, url, type = 'website', keywords = [] }) => {
	...
	const fullTitle = title ? `${capitalizeWords(title)} | ${siteName}` : "Boonfu | Nigeria's Premier Marketplace to Buy, Sell & Earn";
	...
	const defaultDescription = "Join Boonfu, Nigeria's fastest-growing C2C marketplace. Use our unique Grab feature to accelerate sales, shop securely with escrow, or earn commissions as a digital marketer.";
	...
	return (
		<Helmet>
			...
			<meta
				name='description'
				content={description || "Join Boonfu, Nigeria's fastest-growing C2C marketplace. Use our unique Grab feature to accelerate sales, shop securely with escrow, or earn commissions as a digital marketer."}
			/>
