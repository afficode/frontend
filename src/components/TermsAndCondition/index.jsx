...
const TermsAndCondition = ({ setIsOpen, isOpen, rulesRef, termsRef, privacyRef, returnRef }) => {
	return (
		<div ref={termsRef} className="space-y-4 text-justify">
			...
			<p className={textStyles}>
				By using Boonfu, you agree to the collection, transfer, storage, and use of your personal
				information by Boonfu on servers located in England, Spain and South Africa (is the server we
				intend to use in any of these countries?) as further described in our{' '}
				<Link className="underline text-primary">Privacy Notice</Link>
			</p>
			<p className={textStyles}>
				You and Boonfu shall process personal data received under and/or in connection with these Terms
				of Use each as a separate and independent controller. In no event will Boonfu and you process
				personal data under and/or in connection with this User Agreement as joint controllers or in a
				controller-to-processor relationship. As such separate and independent controllers, you shall be
				individually and separately responsible for complying with the obligations that apply to you as
				a controller under applicable data protection law.
			</p>
			<p className={textStyles}>
				You shall comply with your obligations under applicable data protection law (including but not
				limited to the Regulation (Nig General Data Protection Regulation) and supplementing local data
				protection law. This includes, but is not limited to the obligation to provide appropriate
				safeguards for the transfer of personal data to a third country or an international
				organization. You shall process personal data received from Boonfu exclusively for the
				purpose(s) you received the personal data under and/or in connection with these Terms of Use.
				You shall erase the personal data received under these Terms of Use immediately after the
				respective purpose(s) has/have been fulfilled. Any further processing of the personal data is
				not permitted except when legally required (e.g., if a retention obligation applies).
			</p>
			<p className={textStyles}>
				Failure to abide by the aforementioned obligations may result in disciplinary action up to and
				including account suspension.
			</p>
			<p className={textStyles}>
				As part of the services, Boonfu has access to various information about users, including
				personal data. This includes information that users submit to Boonfu as part of the services
				(such as contact information or item descriptions) as well as information that is generated by
				the provision and processing of the services (such as ratings, sales analysis or communication).
			</p>
			<p className={textStyles}>
				Via boonfu.ng and its related websites, services, applications or tools, you receive information
				that is necessary for the processing of transactions (in particular, the contact information of
				the other user involved in a transaction) as well as aggregated information on the performance
				and analysis of your ads, which are partly related to the data of other users of the services
				(such as number of impressions of an ad, conversion rate or return rate).
			</p>
			<p className={textStyles}>
				Boonfu only shares information about users with third parties if this is necessary for the
				provision of the services or if Boonfu is legally or contractually entitled to do so.
			</p>
			<p className={textStyles}>
				Upon expiry of these Terms of Use, we will delete the information you provided, or which was
				generated through your use of the services from your Boonfu account. Regardless, we maintain
				this information after the expiry of these Terms of Use if we are legally obliged or have a
				legitimate interest to do so. We will generally maintain aggregated data generated using the
				services (e.g. statistics about ads in a category) upon expiry of these Terms of Use.
			</p>
			<p className={textStyles}>
				For information regarding the processing of personal data by Boonfu, including sharing such data
				with third parties and your rights as a data subject, please see our{' '}
				<Link className="underline text-primary">Privacy Notice</Link>
			</p>
