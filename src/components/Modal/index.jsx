...
const Modal = ({
  ...
  return (
    <div
      ...
      className={`fixed  inset-0 m-auto backdrop-opacity-5 backdrop-invert bg-white/30 min-h-screen w-full backdrop-blur-sm md:p-0 p-5 items-center justify-center rounded-sm ${
        isOpen ? "flex" : "hidden"
      }`}
    >
      <div
