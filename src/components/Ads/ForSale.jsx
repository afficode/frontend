...
import { GiSkills, GiMoneyStack, GiTakeMyMoney } from "react-icons/gi";
...
const ForSale = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (showError) {
      ...
      const form = document.getElementById("forSalesForm");
      const formData = new FormData(form);
      axios
        .post(backendLink + "/api/forsale", formData, {
    ...
    <div className="w-full px-4 pt-4 mb-4">
      ...
      >
        <h1 className="text-center text-2xl text-green-600 tracking-wider antialiased mb-3 font-bold flex items-center justify-center">
          <GiTakeMyMoney className="text-yellow-300" /> &nbsp; Post Ad for Quick
          Sale
        </h1>
        {/* category  */}
        <div>
          ...
          <div className="bg-gray-200 px-4 pt-4 pb-2 sm:texst-sm text-lg text-gray-500">
            ...
            <input
              ...
              id="forSale"
              name="forSale"
              placeholder="E.g Blender, Engine Oil, Clothes..."
        ...
        <div className="mt-3">
          <div className={disclosureButton}>
            <span className={disclosureButtonDivSpan}>
              Seller Type &emsp; <SiYourtraveldottv className="my-auto" />
            </span>
          </div>
        ...
        <div className="mt-3">
          ...
          <div className="px-4 pt-4 pb-2 sm:texst-sm text-lg text-gray-500 font-bold tracking-wider bg-gray-200">
            ...
            <input
              ...
              id="title"
              name="title"
              placeholder="E.g Elegant Dinner gown..."
              className="w-full px-2 placeholder:text-gray-400 focus:outline-2 focus:outline-blue-300 border border-gray-500 mt-3"
            />
          </div>
        </div>
        ...
        {/* urgent */}
        <div className="py-4 flex flex-col justify-start bg-gray-200 my-3 px-3">
        ...
        <div className="mt-3">
          <div className={disclosureButton}>
            <span className={disclosureButtonDivSpan}>
              Other Features of this produt. &emsp;{" "}
          ...
          <div className="px-4 pt-4 pb-3 items-center text-lg text-gray-500 tracking-tight bg-gray-300">
            <input
              ...
              id="otherFeatures"
              name="otherFeatures"
              placeholder="E.g Silk, Long gown, Friendly Puppy,...."
              className="peer w-full px-2 placeholder:text-gray-400 focus:outline-2 focus:outline-blue-300 border border-gray-500 mt-3"
            />
            <p className="mt-2 invisible peer-focus:visible text-black text-lg">
              Please ensure the features are seperated using comma (,) else you
        ...
        <div className="mt-3">
          <div className={disclosureButton}>
            <span className={disclosureButtonDivSpan}>
              Price &emsp; <GiMoneyStack className="my-auto font-bold" />
            </span>
          </div>
          <div className="px-4 pt-4 pb-3 items-center text-lg text-gray-500 tracking-tight bg-gray-300">
