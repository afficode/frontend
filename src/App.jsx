        ...
        <BrowserRouter>
            <Routes>
                ...
                <Route element={<AppLayout />}>
                    ...
                    />
                    <Route
                        path={Approutes.auth.verifyMail}
                        element={<VerifyMail />}
                    />
                    <Route
                        path={Approutes.auth.reverifyEmail}
                    ...
                    <Route
                        path={Approutes.product.initial}
                        element={<Products />}
                    />
                    <Route
                        path={Approutes.product.view}
                        element={<ViewProduct />}
                    />
                    <Route
                    ...
                    <Route element={<AppLayout />}>
                        <Route element={<DashboardLayout />}>
                            <Route
                                ...
                                element={
                                    <Navigate
                                        to={Approutes.dashboard.performance}
                                    />
                                }
                            />
                            <Route
                            ...
                            />
                            <Route
                                path={Approutes.dashboard.security}
                                element={<Security />}
                            />
                            <Route
                                path={Approutes.dashboard.privacyPolicy}
                                element={<PrivacyPolicy />}
                            />
                            <Route
                                path={Approutes.dashboard.help}
                                element={<Help />}
                            />
                        </Route>
                        <Route element={<GrabLayout />}>
                            ...
                            />
                            <Route
                                path={Approutes.grab.dashboard}
                                element={<GrabDashboard />}
                            />
                            <Route
                        ...
                        <Route
                            path={Approutes.grab.grabbedProduct(
                                ':grabber_id',
                                ':ad_id'
                            )}
                        ...
                        />
                        <Route
                            path={Approutes.checkout.delivery}
                            element={<Delivery />}
                        />
                        <Route
                            path={Approutes.checkout.pickup}
                            element={<Pickup />}
                        />
                        <Route
                            path={Approutes.grab.inspectionLog}
                            element={<InspectionLog />}
                        />
                        ...
                        />
                        <Route
                            path={`${Approutes.postSuccess}/:adId`}
                            element={<PostSuccess />}
                        />
                        <Route
                            path={Approutes.tokenSuccess}
                            element={<Success />}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path={Approutes.grab.paymentSuccess}
                            element={<GrabPaymentSuccess />}
                        />
                        <Route
                            path={Approutes.account.initial}
                        ...
                        >
                            ...
                            />
                            <Route
                                path={Approutes.account.deposit}
                                element={<Deposit />}
                            />
                            <Route
                                path={Approutes.account.withdraw}
                                element={<Withdraw />}
                            />
                        </Route>
                        ...
                        <Route element={<ProfileLayout />}>
                            <Route
                                ...
                                element={
                                    <Navigate to={Approutes.profile.adverts} />
                                }
                            />
                            {/* <Route path={Approutes.profile.details} element={<Details />} /> */}
                            <Route
                                path={Approutes.profile.adverts}
                                element={<Adverts />}
                            />
                            <Route
                                path={Approutes.profile.messages}
                                element={<Messages />}
                            />
                            <Route
                ...
                {/* Logistic routes */}
                <Route
                    path={Approutes.logistics.signup}
                    element={<LogisticSignup />}
                />
                <Route
                    path={Approutes.logistics.login}
                    element={<LogisticLogin />}
                />
                <Route element={<LogisticsLayout />}>
                    <Route
                        path={Approutes.logistics.dashboard}
                        element={<LogisticDashboard />}
                    />
                    <Route
                        path={Approutes.logistics.orders.new}
                        element={<LogisticOrders />}
                    >
                        <Route
                            path={Approutes.logistics.orders.new}
                            element={<LogisticOrdersNew />}
                        />
                    </Route>
                </Route>
